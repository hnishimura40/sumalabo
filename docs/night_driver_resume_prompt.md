...
- 投稿文生成後、`subjectHashtagCandidates`があればXの「最新」で候補をOR指定して1回検索する。過去7日以内に3投稿以上・3アカウント以上ある候補だけ`--validated-subject-tags`で採用し、合格なしはカテゴリ＋`#すまラボ`の2個で進める。連結造語・企業名単体・巨大一般タグは禁止。
