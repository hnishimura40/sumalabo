...
- ハッシュタグは**カテゴリ1＋`#すまラボ`＋X検索で生存確認済みの題材最大2（合計2〜4個）**。候補は投稿直前にXの「最新」で1回検索し、過去7日・3投稿・3アカウント基準を満たしたものだけ採用。合格なしは2個でよい。連結造語・企業名単体・巨大一般タグは禁止（2026-07-27、PR #235の機械抽出を再調整）
