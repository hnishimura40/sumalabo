...
- **本投稿**: 画像4枚（1枚目=サムネ／2〜4枚目=slide01・02・03）＋短い本文＋ハッシュタグ（カテゴリ1＋`#すまラボ`＋題材最大2、合計3〜4個を上限。題材なしは2個）。**本投稿に記事リンクを入れない。**
...
- **ハッシュタグは合計3〜4個を上限（題材なしは2個）** — カテゴリ1個＋`#すまラボ`＋題材タグ最大2個。題材タグは「読者がXで検索しそうな固有名詞か」を基準に、番組名・製品名・サービス名だけを採用する。`#スマホ`・`#ニュース`等の一般語は題材タグにしない
