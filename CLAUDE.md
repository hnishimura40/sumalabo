...
- **本投稿に記事リンクを入れない。** リンクは必ずリプライ側。本投稿は画像＋短文＋ハッシュタグ3〜4個を上限（カテゴリ1＋`#すまラボ`＋題材最大2。題材がなければ2個）。
...
**投稿文ルール：** 短め / 本投稿に URL は入れない（リンクはリプライ） / ハッシュタグはカテゴリ1＋`#すまラボ`＋題材最大2（合計3〜4を上限、題材なしは2） / 題材タグは「読者がXで検索しそうな番組名・製品名・サービス名か」で選び、`#スマホ`・`#ニュース`等の一般語は題材枠に入れない / 「普通の人」表現禁止 / 煽らない / 記事内容に沿う
