...
- らぼまるは腕と手が左右各1つ、脚と足が左右各1つだけ。体から出る追加突起は黄緑アンテナ1本と左右の青い耳ビレだけで、道具を支える謎の手を追加しない。
- 小道具は既存の手だけで持たせる。片手持ちなら空いている手を体側または指定ポーズに置き、両手持ちなら左右の腕が各1本ずつ自然につながるように描く。
- 描画後に人物ごとに腕・手・脚を数え、顔、手指、身体と物体の融合がないことを確認してから保存する。
