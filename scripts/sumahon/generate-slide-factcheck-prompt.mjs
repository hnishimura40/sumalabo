...
10B. **身体構造破綻がないか（公開ブロック・最重要）** — キャラごとに四肢を実際に数え、形・比率・付け根も確認する。**手が描かれている画像は、手の本数と指を重点確認する**。ひまりは腕2本・手2つ・脚2本（見える手は原則各5本指）。らぼまるは腕・手・脚・足が左右各1つで、それ以外の突起は黄緑アンテナ1本と左右の青い耳ビレだけ。らぼまるの腕は短く・太く・丸い正本形状でなければならない。細長い触手状・ホース状・急なS字・にょきっと伸びる腕、腕や脚の不自然な長さ/細さ、付け根や関節の破綻、不快なシルエット、余分/重複した手指や腕、体から生える謎の手、小道具を持つ独立手、顔の破綻、身体と物体の融合は needs_revision（blocking）で、warning に下げない。単に体や画面外に隠れて見えない四肢は、それだけで欠損扱いしない。
