...
10B. **身体構造破綻がないか（公開ブロック・最重要）** — キャラごとに四肢を実際に数える。**手が描かれている画像は、手の本数と指を重点確認する**。ひまりは腕2本・手2つ・脚2本（見える手は原則各5本指）。らぼまるは腕・手・脚・足が左右各1つで、それ以外の突起は黄緑アンテナ1本と左右の青い耳ビレだけ。余分/重複/欠損した手指や腕、体から生える謎の手、小道具を持つ独立手、顔の破綻、身体と物体の融合は needs_revision（blocking）で、warning に下げない。
