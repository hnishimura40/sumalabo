...
11. **身体構造破綻（公開ブロック・最重要）** — 各キャラの四肢を実際に数える。**手が描かれている画像は、最初に手の数と指を重点確認する**。ひまりは腕2本・手2つ・脚2本（見える手は原則各5本指）。らぼまるは腕・手・脚・足が左右各1つで、腕以外の突起は黄緑アンテナ1本と左右の青い耳ビレだけ。手指/腕の本数過多・重複・欠損、体から生える謎の手、小道具を持つ独立した手、顔の破綻、身体と物体の不自然な融合は必ず needs_revision（blocking）とし、warning に下げない。判別不能な軽微な崩れだけ ok_with_warning を許容する。
