...
export async function loadAutomationConfig() {
  const config = await readJson("config/sumalabo-automation.json", defaultConfig);

  return {
    ...defaultConfig,
    ...config,
    chatgptTargets: {
      ...defaultConfig.chatgptTargets,
      ...(config.chatgptTargets || {}),
    },
    browserPolicy: {
